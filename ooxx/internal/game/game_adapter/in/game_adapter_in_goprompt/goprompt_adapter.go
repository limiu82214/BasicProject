package game_adapter_in_goprompt
...
type boardGopromptAdapter struct {
	...
	getBoardStateUseCase   game_application_port_in.IGetBoardStateUseCase
	resetBoardStateUseCase game_application_port_in.IResetBoardStateUseCase
}

func New(
	setStateUserCase game_application_port_in.ISetStateUseCase,
	whoWinUseCase game_application_port_in.IWhoWinUseCase,
	getBoardStateUseCase game_application_port_in.IGetBoardStateUseCase,
	resetBoardStateUseCase game_application_port_in.IResetBoardStateUseCase,
